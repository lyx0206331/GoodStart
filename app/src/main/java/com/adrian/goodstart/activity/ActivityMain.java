...
public class ActivityMain extends BaseActivity {
    ...
    private void buttononclick(){
		...
		Button btimeclock = (Button)findViewById(R.id.button_timeset);
		btimeclock.setOnClickListener(new OnClickListener() {
...
//				intent.setClass(ActivityMain.this,ActivityClock.class);
//				startActivity(intent);
		...
		bnetset.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent();
				intent.setClass(ActivityMain.this,SettingsActivity.class);
				startActivity(intent);
			}
		});

		Button mSendBtn = (Button) findViewById(R.id.btn_send_pics);
                    ...
                    if (cmd == (byte) 0x88) {
                        ...
                        switch (bshortredid) {
                            case R.id.button_shortredA:
                                ...
                                dataUtil.updateCmdBytes(shortredcodeA, 0);
                                break;
                            case R.id.button_shortredB:
                                bshortredflagB = true;
                                shortredcodeB = buf;

                                dataUtil.updateCmdBytes(shortredcodeB, 1);
                                break;
                        }
                    }
                    mProgressDialog.dismiss();
    ...
    private void Deviceinit(byte[] buf) {
        ...
        toast.show();
        dataUtil.updateIp(ip, 0);
        dataUtil.updateIp(ip, 1);
    ...
    private void DeviceList() {
        ...
        builder.setItems(item, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                dataUtil.updateSsid(ssid, 0);
                dataUtil.updateSsid(ssid, 1);
                if (mProgressDialog == null) {
